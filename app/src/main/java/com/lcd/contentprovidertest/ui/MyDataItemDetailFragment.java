package com.lcd.contentprovidertest.ui;
...
import com.lcd.contentprovidertest.MyContentProvider;
import com.lcd.contentprovidertest.MyDataItem;
import com.lcd.contentprovidertest.R;
...
public class MyDataItemDetailFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (arguments.containsKey(ARG_ITEM_ID)) {
			...
			final Cursor ret = getActivity().getContentResolver()
                    .query(ContentUris.withAppendedId(MyContentProvider.ITEMS_URI, id), null, null, null, null);
			ret.moveToFirst();
